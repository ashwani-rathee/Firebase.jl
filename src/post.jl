...
url = "https://firestore.googleapis.com/v1/projects/julian-875a2/databases/(default)/documents/Julian?documentId=600115690520521"
response = post(url)
println(response)

r = HTTP.request("POST", "https://firestore.googleapis.com/v1/projects/julian-875a2/databases/(default)/documents/Julian?documentId=3241")
println(r.status)
